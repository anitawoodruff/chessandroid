...
public class ChessBoardFactory {
     ...
     */
    public static ChessBoard createToFillWidthAndHeight(int w, int h) {
    ...
    private static List<ChessSquare> createListOfEmptySquaresForBoard(
        ...
        for (int i = 0; i < 64; i++) {
            ...
            int color = (x + y) % 2 == 0 ? Color.WHITE : Color.BLACK;
