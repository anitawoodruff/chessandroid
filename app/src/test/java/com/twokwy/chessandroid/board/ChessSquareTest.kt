...
class ChessSquareTest {
    ...
    @Test
    fun isLegalMoveIgnoringCollisions_knightIllegalMove_returnsFalse() {
        val origin = knightAt(Position(0, 0))
        val destination = emptySquareAt(Position(1, 1))
        assertEquals(false, origin.isLegalMoveIgnoringCollisions(destination))
    }

    @Test
    fun isLegalMoveIgnoringCollisions_knight_rightTwoUpOne_returnsTrue() {
        val origin = knightAt(Position(0, 0))
        val destination = emptySquareAt(Position(2, 1))
        assertEquals(true, origin.isLegalMoveIgnoringCollisions(destination))
    }

    @Test
    fun isLegalMoveIgnoringCollisions_knight_rightOneUpTwo_returnsTrue() {
        val origin = knightAt(Position(0, 0))
    ...
    @Test
    fun isLegalMoveIgnoringCollisions_knight_rightTwoDownOne_returnsTrue() {
    ...
    @Test
    fun isLegalMoveIgnoringCollisions_knight_rightOneDownTwo_returnsTrue() {
    ...
    @Test
    fun isLegalMoveIgnoringCollisions_knight_leftOneUpTwo_returnsTrue() {
    ...
    @Test
    fun isLegalMoveIgnoringCollisions_knight_leftOneDownTwo_returnsTrue() {
